...
- [x] 3. ShelfieApp を AdaptiveApp.router に移行する
- [x] 3.1 MaterialApp.router を AdaptiveApp.router に置き換える
...
- [x] 3.2 Localization 設定を AdaptiveApp.router に移行する
  - 既存の localizationsDelegates と supportedLocales を AdaptiveApp.router のパラメータに渡す
  - アプリの多言語表示が従来通り動作することを確認する
  - _Requirements: 1.4_

- [x] 4. MainShell を AdaptiveScaffold と AdaptiveBottomNavigationBar に移行する
- [x] 4.1 Scaffold を AdaptiveScaffold に置き換える
  - ShellRoute の builder 内で Scaffold を AdaptiveScaffold に変更する
  - body に go_router の child ウィジェットをそのまま渡す
  - _Requirements: 3.1, 3.2_

- [x] 4.2 カスタムタブバーを AdaptiveBottomNavigationBar に置き換える

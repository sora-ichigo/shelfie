...
- [x] 10.2 Provider ユニットテストの作成
  - AuthProvider のユニットテストを作成（注: ThemeModeNotifier はスキップ済み）
  - BaseRepository のエラーハンドリングテストを作成
  - 10.1 のユーティリティを使用
  - _Requirements: 5.1, 5.3_

- [x] 10.3 共通ウィジェットのウィジェットテストの作成
  - LoadingIndicator のウィジェットテストを作成（既存テストにダークモードテストを追加）
  - ErrorView のウィジェットテストを作成（既存テストにダークモードテストを追加）
  - EmptyState のウィジェットテストを作成（既存テストにダークモードテストを追加）
  - ダークモードでの表示確認を含める（ライトモードはスキップ）
  - _Requirements: 5.1, 5.4_

- [x] 10.4 テーマ適用のウィジェットテストの作成
  - AppTheme のダークモードでのテストを作成（ライトモードはスキップ）
  - ThemeExtension のアクセスとアニメーション（lerp）のテストを作成
  - _Requirements: 5.4_

- [x] 10.5 ルーターのウィジェットテストの作成
  - AppRouter のナビゲーションテストを作成（既存テストを確認）
  - 認証ガードのリダイレクトテストを作成
  - ディープリンクのルーティングテストを作成
  - _Requirements: 5.4_

- [x] 10.6 CI テストカバレッジ計測の設定
  - flutter test --coverage コマンドの設定
  - カバレッジレポート生成の設定
  - CI パイプラインでのカバレッジ計測フックを準備
  - _Requirements: 5.6_

- [x] 10.7 インテグレーションテストの作成

...
- [x] 8. Mobile UI コンポーネントの実装
- [x] 8.1 (P) BookListCard ウィジェット（縦長バリアント）を実装する
...
- [x] 8.2 (P) BookListCard ウィジェット（横長バリアント）を実装する
  - 単一表紙画像の表示を実装する

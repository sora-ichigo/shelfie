...
- [ ] 2. 認証状態のゲストモード対応（コア層）
- [ ] 2.1 AuthStateData にゲストモードフラグを追加する
...
- [ ] 2.2 SecureStorageService にゲストモード永続化機能を追加する
...
- [ ] 2.3 AuthState にゲストモード開始・復元・解除ロジックを追加する
...
- [ ] 3.1 guardRoute にゲストモード時のルート判定ロジックを追加する
...
- [ ] 4. ウェルカム画面のゲストモード対応
- [ ] 4.1 ウェルカム画面に「アカウントなしで利用」リンクを追加する
...
- [ ] 4.2 ウェルカム画面のゲストモード開始オーケストレーションを実装する

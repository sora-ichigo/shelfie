...
- [x] 1. App Store 用コード署名の構成
- [x] 1.1 (P) App Store 用 ExportOptions.plist を作成する
...
- [x] 1.2 (P) Fastfile に App Store 用証明書取得レーンを追加する
...
- [x] 3. App Store Connect メタデータをリポジトリ内で管理する
- [x] 3.1 (P) メタデータディレクトリ構造を作成する

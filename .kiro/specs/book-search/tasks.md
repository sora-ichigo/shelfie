...
- [x] 11. モバイルアプリユニットテストの実装
- [x] 11.1 (P) BookSearchNotifier のユニットテスト
  - デバウンス動作のテストを実装する
  - 検索状態遷移のテストを実装する
  - エラーハンドリングのテストを実装する
  - _Requirements: 1.2, 6.5_

- [x] 11.2 (P) 検索画面のウィジェットテスト
  - 検索バーの入力テストを実装する
  - 検索結果表示のテストを実装する
  - ローディング状態のテストを実装する

...
- [x] 6.2 FollowRequestNotifier を実装する（タスク 5.3, 6.1 の完了が前提）
...
- [x] 6.3 FollowRequestListNotifier を実装する（タスク 5.3, 6.1 の完了が前提）
...
- [x] 6.4 (P) FollowListNotifier を実装する（タスク 5.3, 6.1 の完了が前提）
...
- [x] 6.5 (P) NotificationListNotifier を実装する（タスク 5.4, 6.1 の完了が前提）
...
- [x] 6.6 (P) UnreadNotificationCount Provider を実装する（タスク 5.4, 6.1 の完了が前提）
...
- [ ] 7. モバイル UI 画面の実装
- [x] 7.1 お知らせ画面を実装する（タスク 6.5, 6.6 の完了が前提）
...
- [x] 7.2 フォローリクエスト一覧画面を実装する（タスク 6.3 の完了が前提）
...
- [x] 7.3 (P) フォロー/フォロワー一覧画面を実装する（タスク 6.4 の完了が前提）
...
- [x] 7.4 他ユーザープロフィール画面を実装する（タスク 6.2 の完了が前提）
...
- [x] 7.5 既存プロフィール画面にフォロー数・招待リンクを統合する（タスク 6.1 の完了が前提）
...
- [x] 8.1 ボトムナビゲーションにお知らせタブを追加する（タスク 7.1, 6.6 の完了が前提）
  - ボトムナビゲーションバーに「お知らせ」タブ（ベルアイコン）を追加する
  - タブ構成を [本棚, 検索, +追加, お知らせ, プロフィール] に変更する
  - 未読件数のバッジを表示する
  - _Requirements: 12.1, 12.6_

- [x] 8.2 フォロー関連画面のルーティングを設定する（タスク 7.1, 7.2, 7.3, 7.4 の完了が前提）

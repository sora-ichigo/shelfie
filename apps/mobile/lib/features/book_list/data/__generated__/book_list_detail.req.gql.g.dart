...
part of 'book_list_detail.req.gql.dart';
...
class _$GBookListDetailReqSerializer
  ...
  @override
  final Iterable<Type> types = const [GBookListDetailReq, _$GBookListDetailReq];
  @override
  final String wireName = 'GBookListDetailReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GBookListDetailReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GBookListDetailVars)),
      'operation',
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GBookListDetailData)));
    }
...
class _$GBookListDetailReq extends GBookListDetailReq {
  @override
  final _i3.GBookListDetailVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GBookListDetailData? Function(
      _i2.GBookListDetailData?, _i2.GBookListDetailData?)? updateResult;
  @override
  final _i2.GBookListDetailData? optimisticResponse;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GBookListDetailReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GBookListDetailReq')
          ..add('vars', vars)
...
class GBookListDetailReqBuilder
    implements Builder<GBookListDetailReq, GBookListDetailReqBuilder> {
  _$GBookListDetailReq? _$v;
  ...
  _i2.GBookListDetailData? Function(
      _i2.GBookListDetailData?, _i2.GBookListDetailData?)? _updateResult;
  _i2.GBookListDetailData? Function(
          _i2.GBookListDetailData?, _i2.GBookListDetailData?)?
  ...
  GBookListDetailReqBuilder() {
    GBookListDetailReq._initializeBuilder(this);
  }

  GBookListDetailReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GBookListDetailReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GBookListDetailReq build() => _build();

  _$GBookListDetailReq _build() {

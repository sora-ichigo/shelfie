...
part of 'delete_book_list.req.gql.dart';
...
class _$GDeleteBookListReqSerializer
  ...
  @override
  final Iterable<Type> types = const [GDeleteBookListReq, _$GDeleteBookListReq];
  @override
  final String wireName = 'GDeleteBookListReq';
...
class _$GDeleteBookListReq extends GDeleteBookListReq {
  @override
  final _i3.GDeleteBookListVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GDeleteBookListReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GDeleteBookListReq')
          ..add('vars', vars)
...
class GDeleteBookListReqBuilder
    implements Builder<GDeleteBookListReq, GDeleteBookListReqBuilder> {
  _$GDeleteBookListReq? _$v;
  ...
  GDeleteBookListReqBuilder() {
    GDeleteBookListReq._initializeBuilder(this);
  }

  GDeleteBookListReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GDeleteBookListReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GDeleteBookListReq build() => _build();

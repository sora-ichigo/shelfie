...
part of 'add_book_to_list.req.gql.dart';
...
class _$GAddBookToListReqSerializer
  ...
  @override
  final Iterable<Type> types = const [GAddBookToListReq, _$GAddBookToListReq];
  @override
...
class _$GAddBookToListReq extends GAddBookToListReq {
  @override
  final _i3.GAddBookToListVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GAddBookToListReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GAddBookToListReq')
          ..add('vars', vars)
...
class GAddBookToListReqBuilder
    implements Builder<GAddBookToListReq, GAddBookToListReqBuilder> {
  _$GAddBookToListReq? _$v;
  ...
  GAddBookToListReqBuilder() {
    GAddBookToListReq._initializeBuilder(this);
  }

  GAddBookToListReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GAddBookToListReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GAddBookToListReq build() => _build();

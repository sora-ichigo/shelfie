...
class BookDetailNotifier extends _$BookDetailNotifier {
  ...
  Future<Either<Failure, ShelfEntry>> updateThoughts({
    required int userBookId,
    ...
    return ref.read(shelfStateProvider.notifier).updateThoughtsWithApi(
      externalId: externalId,
      thoughts: thoughts,
    );
  }

  Future<Either<Failure, ShelfEntry>> updateStartedAt({
    required int userBookId,
    ...
    return ref.read(shelfStateProvider.notifier).updateStartedAtWithApi(
      externalId: externalId,
      startedAt: startedAt,
    );
  }

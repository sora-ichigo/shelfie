...
part of 'update_reading_status.req.gql.dart';
...
class _$GUpdateReadingStatusReq extends GUpdateReadingStatusReq {
  @override
  final _i3.GUpdateReadingStatusVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GUpdateReadingStatusReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUpdateReadingStatusReq')
          ..add('vars', vars)
...
class GUpdateReadingStatusReqBuilder
    implements
        Builder<GUpdateReadingStatusReq, GUpdateReadingStatusReqBuilder> {
  _$GUpdateReadingStatusReq? _$v;
  ...
  GUpdateReadingStatusReqBuilder() {
    GUpdateReadingStatusReq._initializeBuilder(this);
  }

  GUpdateReadingStatusReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GUpdateReadingStatusReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GUpdateReadingStatusReq build() => _build();

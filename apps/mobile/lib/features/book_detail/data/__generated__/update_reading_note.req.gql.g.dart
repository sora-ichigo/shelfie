...
part of 'update_reading_note.req.gql.dart';
...
class _$GUpdateReadingNoteReqSerializer
  ...
  final Iterable<Type> types = const [
    ...
    _$GUpdateReadingNoteReq
  ];
  @override
  final String wireName = 'GUpdateReadingNoteReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GUpdateReadingNoteReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GUpdateReadingNoteVars)),
      'operation',
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GUpdateReadingNoteData)));
    }
...
class _$GUpdateReadingNoteReq extends GUpdateReadingNoteReq {
  @override
  final _i3.GUpdateReadingNoteVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GUpdateReadingNoteData? Function(
      _i2.GUpdateReadingNoteData?, _i2.GUpdateReadingNoteData?)? updateResult;
  @override
  final _i2.GUpdateReadingNoteData? optimisticResponse;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GUpdateReadingNoteReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUpdateReadingNoteReq')
          ..add('vars', vars)
...
class GUpdateReadingNoteReqBuilder
    implements Builder<GUpdateReadingNoteReq, GUpdateReadingNoteReqBuilder> {
  _$GUpdateReadingNoteReq? _$v;
  ...
  _i2.GUpdateReadingNoteData? Function(
      _i2.GUpdateReadingNoteData?, _i2.GUpdateReadingNoteData?)? _updateResult;
  _i2.GUpdateReadingNoteData? Function(
          _i2.GUpdateReadingNoteData?, _i2.GUpdateReadingNoteData?)?
  ...
  GUpdateReadingNoteReqBuilder() {
    GUpdateReadingNoteReq._initializeBuilder(this);
  }

  GUpdateReadingNoteReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GUpdateReadingNoteReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GUpdateReadingNoteReq build() => _build();

  _$GUpdateReadingNoteReq _build() {

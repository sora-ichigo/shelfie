...
part of 'update_completed_at.req.gql.dart';
...
class _$GUpdateCompletedAtReq extends GUpdateCompletedAtReq {
  @override
  final _i3.GUpdateCompletedAtVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GUpdateCompletedAtReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUpdateCompletedAtReq')
          ..add('vars', vars)
...
class GUpdateCompletedAtReqBuilder
    implements Builder<GUpdateCompletedAtReq, GUpdateCompletedAtReqBuilder> {
  _$GUpdateCompletedAtReq? _$v;
  ...
  GUpdateCompletedAtReqBuilder() {
    GUpdateCompletedAtReq._initializeBuilder(this);
  }

  GUpdateCompletedAtReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GUpdateCompletedAtReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GUpdateCompletedAtReq build() => _build();

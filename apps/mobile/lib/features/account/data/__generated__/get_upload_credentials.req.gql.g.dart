...
part of 'get_upload_credentials.req.gql.dart';
...
class _$GGetUploadCredentialsReq extends GGetUploadCredentialsReq {
  @override
  final _i3.GGetUploadCredentialsVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GGetUploadCredentialsReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GGetUploadCredentialsReq')
          ..add('vars', vars)
...
class GGetUploadCredentialsReqBuilder
    implements
        Builder<GGetUploadCredentialsReq, GGetUploadCredentialsReqBuilder> {
  _$GGetUploadCredentialsReq? _$v;
  ...
  GGetUploadCredentialsReqBuilder() {
    GGetUploadCredentialsReq._initializeBuilder(this);
  }

  GGetUploadCredentialsReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GGetUploadCredentialsReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GGetUploadCredentialsReq build() => _build();

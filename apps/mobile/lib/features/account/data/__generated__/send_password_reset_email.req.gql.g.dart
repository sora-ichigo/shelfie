...
part of 'send_password_reset_email.req.gql.dart';
...
class _$GSendPasswordResetEmailReq extends GSendPasswordResetEmailReq {
  @override
  final _i3.GSendPasswordResetEmailVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GSendPasswordResetEmailReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GSendPasswordResetEmailReq')
          ..add('vars', vars)
...
class GSendPasswordResetEmailReqBuilder
    implements
        Builder<GSendPasswordResetEmailReq, GSendPasswordResetEmailReqBuilder> {
  _$GSendPasswordResetEmailReq? _$v;
  ...
  GSendPasswordResetEmailReqBuilder() {
    GSendPasswordResetEmailReq._initializeBuilder(this);
  }

  GSendPasswordResetEmailReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GSendPasswordResetEmailReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GSendPasswordResetEmailReq build() => _build();

...
import 'package:shelfie/features/account/data/__generated__/request_email_change.ast.gql.dart'
    as _i5;
...
part 'request_email_change.req.gql.g.dart';
...
abstract class GRequestEmailChangeReq
  ...
  factory GRequestEmailChangeReq(
          [void Function(GRequestEmailChangeReqBuilder b) updates]) =
  ...
  @override
  Map<String, dynamic> dataToJson(_i2.GRequestEmailChangeData data) =>
      data.toJson();

  @override
  _i1.OperationRequest<_i2.GRequestEmailChangeData, _i3.GRequestEmailChangeVars>

...
class _$GUserProfileReqSerializer
  ...
  GUserProfileReq deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = GUserProfileReqBuilder();
...
class _$GUserProfileReq extends GUserProfileReq {
  ...
  factory _$GUserProfileReq([void Function(GUserProfileReqBuilder)? updates]) =>
      (GUserProfileReqBuilder()..update(updates))._build();
  ...
  @override
  GUserProfileReqBuilder toBuilder() => GUserProfileReqBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUserProfileReq')
          ..add('vars', vars)
...
class GUserProfileReqBuilder
  ...
  _i3.GUserProfileVarsBuilder get vars =>
      _$this._vars ??= _i3.GUserProfileVarsBuilder();
  ...
  _i2.GUserProfileDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= _i2.GUserProfileDataBuilder();
  ...
  @override
  GUserProfileReq build() => _build();

  _$GUserProfileReq _build() {
    ...
    try {
      _$result = _$v ??
          _$GUserProfileReq._(
            ...
            operation: BuiltValueNullFieldError.checkNotNull(
                operation, r'GUserProfileReq', 'operation'),
            requestId: requestId,
            ...
            executeOnListen: BuiltValueNullFieldError.checkNotNull(
                executeOnListen, r'GUserProfileReq', 'executeOnListen'),
            context: context,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GUserProfileReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

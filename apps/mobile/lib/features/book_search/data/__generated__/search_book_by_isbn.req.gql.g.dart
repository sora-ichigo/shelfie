...
part of 'search_book_by_isbn.req.gql.dart';
...
class _$GSearchBookByISBNReqSerializer
  ...
  @override
  final String wireName = 'GSearchBookByISBNReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GSearchBookByISBNReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GSearchBookByISBNVars)),
      'operation',
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GSearchBookByISBNData)));
    }
...
class _$GSearchBookByISBNReq extends GSearchBookByISBNReq {
  @override
  final _i3.GSearchBookByISBNVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GSearchBookByISBNData? Function(
      _i2.GSearchBookByISBNData?, _i2.GSearchBookByISBNData?)? updateResult;
  @override
  final _i2.GSearchBookByISBNData? optimisticResponse;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GSearchBookByISBNReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GSearchBookByISBNReq')
          ..add('vars', vars)
...
class GSearchBookByISBNReqBuilder
    implements Builder<GSearchBookByISBNReq, GSearchBookByISBNReqBuilder> {
  _$GSearchBookByISBNReq? _$v;
  ...
  _i2.GSearchBookByISBNData? Function(
      _i2.GSearchBookByISBNData?, _i2.GSearchBookByISBNData?)? _updateResult;
  _i2.GSearchBookByISBNData? Function(
          _i2.GSearchBookByISBNData?, _i2.GSearchBookByISBNData?)?
  ...
  GSearchBookByISBNReqBuilder() {
    GSearchBookByISBNReq._initializeBuilder(this);
  }

  GSearchBookByISBNReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GSearchBookByISBNReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GSearchBookByISBNReq build() => _build();

  _$GSearchBookByISBNReq _build() {

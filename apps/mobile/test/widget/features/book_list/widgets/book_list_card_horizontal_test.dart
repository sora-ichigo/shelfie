...
void main() {
  ...
  group('BookListCard horizontal variant', () {
    group('single cover image display', () {
      testWidgets('displays first cover image', (tester) async {
        ...
        final singleCover = find.byType(SingleCoverImage);

...
void main() {
  group('StatusSectionList', () {
    group('表示順', () {
      testWidgets('先頭2セクションが気になる→積読の順で表示される', (tester) async {
      ...
      testWidgets('積読のセクションは読書中の前に表示される（completedなし）',
          (tester) async {
        await tester.pumpWidget(
          _buildTestWidget(
            states: {
